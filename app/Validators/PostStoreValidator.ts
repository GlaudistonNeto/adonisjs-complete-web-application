...
export default class PostStoreValidator {
  ...
  public schema = schema.create({
    ...
    slug: schema.string.optional({}, [rules.maxLength(100)]),
    pageTitle: schema.string.optional({}, [rules.maxLength(255)]),
    ...
    publishdAt: schema.date.optional(),
    publishdAtUser: schema.string.optional(),
